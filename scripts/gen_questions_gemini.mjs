...
- تصنيف "من أنا؟": أسئلة يصف فيها السؤال شخصية أو مكاناً أو شيئاً والمطلوب التعرف عليه (مثل: من أنا؟ أنا صحابي جليل، أول من استشهد في الإسلام...).
- تصنيف "التاريخ": أحداث تاريخية، تواريخ، عصور، حروب، دول قديمة وحديثة، شخصيات تاريخية.
